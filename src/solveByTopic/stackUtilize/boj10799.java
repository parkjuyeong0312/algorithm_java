package solveByTopic.stackUtilize;
...
//ready =false
//pipeNum은
    //1. solveByTopic.stack.size() <= 1 : pipeNum = 0
    //2. solveByTopic.stack.size() >2 : pipeNum = solveByTopic.stack.size()
//<풀이>
// 맨 처음에 (로 시작한다.
    //pipeNum=0인 상태이다.
// (가 나올때 :
    //ready=true;
    //solveByTopic.stack.push('(')
// )가 나올때
    //ready=true일때,
        //solveByTopic.stack.pop()
        //레이저발싸! sum+=pipeNum
    //ready=false일때
        //solveByTopic.stack.pop()
        //sum+=1
